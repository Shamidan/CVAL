...
bus_url = ClientSettings().bus_url

bus = BusHTTP(bus_url)
print('Шина есть')
cvat_settings = CVATSettings()
print("настройки cvat есть")
print(cvat_settings.user_name)
print(cvat_settings.password)
print(cvat_settings.cvat_url)
...
print("Готовлю запуск приложения")
